...
"Long term grassland bird monitoring on Duke Farms: 2010-2025" 
prepared by Michael C. Allen, Ph. D., Tsuga Biodiversity Insights, LLC

## Repository structure & usage

See repository structure diagram in the next section and dependency information in the last section.
The R project file "duke_2025.Rproj" allows the code to be run within a self-contained directory (duke_2025). e.g., within RStudio.
The main.R file contains the core logic of the workflow. It runs setup.R which installs necessary libraries and functions. It also allows running of the 7 steps to the analysis via the corresponding functions found in the R folder. 
The script in the bugs folder defines the hierarchical distance sampling model.
